...
function App() {
    ...
    const result = await fetch(
      "https://api.siliconflow.cn/v1/chat/completions",
      {
        ...
        headers: {
          ...
          Authorization: "Bearer sk-fmrrgidrrtnxmpvfvnbptwtknowcqunejhmrwaomuwloxifl",
        },
        body: JSON.stringify({
  ...
  return (
    <div className="full">
      ...
      >
        <img src={process.env.PUBLIC_URL + "/images/icons/menu.png"} alt="menu"></img>
      </div>
      ...
      <div className="chat-div">
        ...
        <div className="msg-box">
          ...
          >
            <img src={process.env.PUBLIC_URL + "/images/icons/mic.png"} alt="mic" unselectable="on"></img>
          </button>
          <input
            type="text"
            value={msg}
          ...
          >
            <img src={process.env.PUBLIC_URL + "/images/icons/send.png"} alt="mic"></img>
          </button>
        </div>
      </div>
      <ReactAudioPlayer
      ...
      /> */}
        ...
        <Suspense fallback={null}>
          <Environment
            background={false}
            files={process.env.PUBLIC_URL + "/images/photo_studio_loft_hall_1k.hdr"}
          />
        </Suspense>
...
function Bg() {
  const texture = useTexture(`${process.env.PUBLIC_URL}/images/background.jpg`);
